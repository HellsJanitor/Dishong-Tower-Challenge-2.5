zzzAGF-V2-Compatibilities
7d2d Version 2 - v4.0.0
...
3.  INSTALLATION and REMOVAL NOTES
	*First, if you run into any conflicts, you may contact AuroraGiggleFairy via discord: https://discord.gg/Vm5eyW6N4r
	...
	-zzzAGF-V2-Compatibilities is SAFE to install on new game or existing game.
	-zzzAGF-V2-Compatibilities is DANGEROUS to remove from an existing game.
